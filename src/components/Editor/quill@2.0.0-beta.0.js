    ...
    var t = {
        3500: function (t, e, n) {
          ...
          function h(t) {
            ...
            return t
              ...
              .reduce((t, n) => (0 === n.length() ? t : t.insert(n.value(), d(n, {}, e))), new (s())())
              .insert('\n', d(t))
          }
          function d(t) {
            ...
            return null == t
              ...
              : ('formats' in t &&
                  ...
                  n && delete e['code-token']),
                null == t.parent || 'scroll' === t.parent.statics.blotName || t.parent.statics.scope !== t.statics.scope
                  ? e
                  : d(t.parent, e, n))
          }
        ...
        5191: function (t, e, n) {
          ...
          class s extends r.EmbedBlot {
            ...
            restore() {
              ...
              if ((this.remove(), t)) {
                const i = (t, i) =>
                    e && t === e.domNode ? i : t === l ? n + i - 1 : r && t === r.domNode ? n + a.length + i : null,
          ...
          class m extends u.ScrollBlot {
            ...
            insertContents(t, e) {
              ...
              if (s) {
                const e =
                    'block' === s.type &&
                    (0 === s.delta.length() || (!this.descendant(i.i2, t)[0] && t < this.length())),
                  n =
                    'block' === s.type
                      ? s.delta
                      : new (d())().insert({
              ...
              n.length &&
                ...
                'block' === r.type && r.delta.length() && b(this, o ? o.offset(o.scroll) + l : this.length(), r.delta),
                this.batchEnd(),
                this.optimize()
            }
            isEnabled() {
            ...
            optimize() {
              ...
              this.batch || (super.optimize(t, e), t.length > 0 && this.emitter.emit(f.Z.events.SCROLL_OPTIMIZE, t, e))
            }
            path(t) {
                ...
                this.quill.on(r.ZP.events.EDITOR_CHANGE, (t, e, n, i) => {
                  t === r.ZP.events.SELECTION_CHANGE
                    ...
                    : t === r.ZP.events.TEXT_CHANGE &&
                      (this.ignoreChange ||
                        (this.options.userOnly && i !== r.ZP.sources.USER ? this.transform(e) : this.record(e, n)),
                    ...
                    (function (t, e) {
                      ...
                      return (
                        ...
                        (null != n.insert
                          ...
                          : null != n.attributes &&
                            Object.keys(n.attributes).some((e) => null != t.query(e, u.Scope.BLOCK)))
                      )
                    })(t, e) && (r -= 1),
                    r
                  )
          ...
          class L extends N.Z {
            ...
            replaceText(t) {
              ...
              if (e) {
                ...
                this.deleteRange(t),
                  this.quill.updateContents(new (d())().retain(t.index).insert(e, n), r.ZP.sources.USER)
              } else this.deleteRange(t)
              return this.quill.setSelection(t.index + e.length, 0, r.ZP.sources.SILENT), !0
            }
            handleBeforeInput(t) {
              if (this.quill.composition.isComposing || t.defaultPrevented || !_.includes(t.inputType)) return
              ...
              this.quill.keyboard.addBinding({
                ...
                handler(t, e) {
                  ...
                  return (
                    ...
                    (this.quill.setSelection(t.index - 1, t.length + (i.shiftKey ? 1 : 0), r.ZP.sources.USER), !1)
                  )
                },
              })
            }
        ...
        1274: function (t, e, n) {
          ...
          var r = n(161),
            i = n.n(r),
            s = n(4431)
          const o = (0, n(1204).Z)('quill:events')
          ...
          class l extends i() {
            ...
            constructor() {
              super(), (this.listeners = {}), this.on('error', o.error)
            }
            emit() {
              for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++) e[n] = arguments[n]
              return o.log.call(o, ...e), super.emit(...e)
            }
            handleDOM(t) {
              for (var e = arguments.length, n = new Array(e > 1 ? e - 1 : 0), r = 1; r < e; r++)
                n[r - 1] = arguments[r]
              ;(this.listeners[t.type] || []).forEach((e) => {
                const { node: r, handler: i } = e
        ...
        250: function (t, e, n) {
          ...
          function g(t, e, n) {
            ...
            const [{ child: r, offset: i, length: s, indent: o, type: l }, ...a] = t,
              [c, u] = y(l)
            if (o > e)
              return n.push(l), o === e + 1 ? `<${c}><li${u}>${m(r, i, s)}${g(a, o, n)}` : `<${c}><li>${g(t, e + 1, n)}`
          ...
          var N = class {
              ...
              applyDelta(t) {
                ...
                return (
                  (function (t) {
                    ...
                    if (null != n.insert) {
                      if ((i.retain(l), 'string' == typeof n.insert)) {
                        ...
                        if (l) (e <= t || this.scroll.descendant(c.i2, t)[0]) && (h = !0)
                        else if (t > 0) {
                          const [e, n] = this.scroll.descendant(s.LeafBlot, t - 1)
                          e instanceof d.Z
                            ? '\n' !== e.value()[n] && (u = !0)
                            : e instanceof s.EmbedBlot && e.statics.scope === s.Scope.INLINE_BLOT && (u = !0)
                        }
                      ...
                      e += l
                    } else if ((i.push(n), null !== n.retain && 'object' == typeof n.retain)) {
                  ...
                  i.reduce(
                    (t, e) =>
                      'number' == typeof e.delete ? (this.scroll.deleteAt(t, e.delete), t) : t + o.Op.length(e),
                    0
                  ),
              ...
              deleteText(t, e) {
                return this.scroll.deleteAt(t, e), this.update(new (l())().retain(t).delete(e))
              }
              formatLine(t, e) {
                const n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {}
                this.scroll.update(),
              ...
              getFormat(t) {
                ...
                0 === e
                  ? this.scroll.path(t).forEach((t) => {
                      const [e] = t
                      e instanceof c.ZP ? n.push(e) : e instanceof s.LeafBlot && r.push(e)
                    })
                  : ((n = this.scroll.lines(t, e)), (r = this.scroll.descendants(s.LeafBlot, t, e)))
                const [i, o] = [n, r].map((t) => {
                  const e = t.shift()
                  if (null == e) return {}
                  let n = (0, c.E2)(e)
              ...
              getHTML(t, e) {
                ...
                if (n) {
                  const i = n.length()
                  return n.length() >= r + e ? m(n, r, e, !(0 === r && e === i)) : m(this.scroll, t, e, !0)
                }
                return ''
              }
              getText(t, e) {
              ...
              update(t) {
                ...
                if (
                  ...
                  const i = this.scroll.find(e[0].target),
                    ...
                    f = n && {
                      oldRange: x(n.oldRange, -o),
                      newRange: x(n.newRange, -o),
                    }
                  ;(t = new (l())()
                    .retain(o)
                    .concat(u.diff(d, f))
                    .reduce((t, e) => (e.insert ? t.insert(e.insert, s) : t.push(e)), new (l())())),
                    (this.delta = r.compose(t))
                } else
                  (this.delta = this.getDelta()),
                    (t && (0, a.Z)(r.compose(t), this.delta)) || (t = r.diff(this.delta, n))
                return t
              }
            },
            E = n(1274),
              ...
              setupListeners() {
                this.scroll.domNode.addEventListener('compositionstart', (t) => {
                  ...
                  this.scroll.domNode.addEventListener('compositionend', (t) => {
                    this.isComposing && this.handleCompositionEnd(t)
                  })
              }
          ...
          const L = (t) => {
            ...
            O = (t, e, n, r, i, s) =>
              t < n && e > r ? 0 : t < n ? -(n - t + i) : e > r ? (e - t > r - n ? t + i - n : e - r + s) : 0
          const T = (0, A.Z)('quill'),
            j = new s.Registry()
          ...
          class C {
            ...
            static register(t, e) {
              ...
              if ('string' != typeof t) {
                ...
                null == this.imports[t] || n || T.warn(`Overwriting ${t} with`, e),
                  (this.imports[t] = e),
                  (t.startsWith('blots/') || t.startsWith('formats/')) && 'abstract' !== e.blotName && j.register(e),
            ...
            constructor(t) {
              ...
              const o = this.options.registry.query(s.ScrollBlot.blotName)
              if (
                ...
                this.emitter.on(E.Z.events.EDITOR_CHANGE, (t) => {
                  t === E.Z.events.TEXT_CHANGE && this.root.classList.toggle('ql-blank', this.editor.isBlank())
                }),
                ...
                this.emitter.on(E.Z.events.SCROLL_EMBED_UPDATE, (t, e) => {
                  ...
                  R.call(
                    this,
                    () => {
                      const n = new (l())().retain(t.offset(this)).retain({
            ...
            deleteText(t, e, n) {
              return ([t, e, , n] = P(t, e, n)), R.call(this, () => this.editor.deleteText(t, e), n, t, -1 * e)
            }
            disable() {
              this.enable(!1)
            }
            ...
            format(t, e) {
              const n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : E.Z.sources.API
              return R.call(
                this,
                () => {
                  ...
                  if (this.scroll.query(t, s.Scope.BLOCK))
                    r = this.editor.formatLine(n.index, n.length, {
                      [t]: e,
                    })
                  else {
            ...
            formatLine(t, e, n, r, i) {
              let s
              return ([t, e, s, i] = P(t, e, n, r, i)), R.call(this, () => this.editor.formatLine(t, e, s), i, t, 0)
            }
            formatText(t, e, n, r, i) {
              let s
              return ([t, e, s, i] = P(t, e, n, r, i)), R.call(this, () => this.editor.formatText(t, e, s), i, t, 0)
            }
            getBounds(t) {
              const e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 0,
                n = null
            ...
            getFormat() {
              const t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.getSelection(!0),
            ...
            getSemanticHTML() {
              ...
              return 'number' == typeof t && (e = this.getLength() - t), ([t, e] = P(t, e)), this.editor.getHTML(t, e)
            }
            getText() {
              let t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0,
                e = arguments.length > 1 ? arguments[1] : void 0
              return 'number' == typeof t && (e = this.getLength() - t), ([t, e] = P(t, e)), this.editor.getText(t, e)
            }
            hasFocus() {
              return this.selection.hasFocus()
            }
            insertEmbed(t, e, n) {
              const r = arguments.length > 3 && void 0 !== arguments[3] ? arguments[3] : C.sources.API
              return R.call(this, () => this.editor.insertEmbed(t, e, n), r, t)
            }
            insertText(t, e, n, r, i) {
              let s
              return (
                ([t, , s, i] = P(t, 0, n, r, i)), R.call(this, () => this.editor.insertText(t, e, s), i, t, e.length)
              )
            }
            isEnabled() {
              ...
              ;((t, e) => {
                ...
                for (; i; ) {
                  const t = i === n.body,
                    ...
                    l = O(r.left, r.right, e.left, e.right, S(o.scrollPaddingLeft), S(o.scrollPaddingRight)),
                    a = O(r.top, r.bottom, e.top, e.bottom, S(o.scrollPaddingTop), S(o.scrollPaddingBottom))
                  if (l || a)
            ...
            setContents(t) {
              const e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : E.Z.sources.API
              return R.call(
                this,
                () => {
                  t = new (l())(t)
            ...
            update() {
              const t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : E.Z.sources.USER
          ...
          function R(t, e, n, r) {
            if (!this.isEnabled() && e === E.Z.sources.USER && !this.allowReadOnlyEdits) return new (l())()
            ...
            if (
              ...
              this.emitter.emit(E.Z.events.EDITOR_CHANGE, ...t), e !== E.Z.sources.SILENT && this.emitter.emit(...t)
            }
            return o
          }
          function P(t, e, n, r, i) {
            ...
            return (
              ...
              'object' == typeof n ? ((s = n), (i = r)) : 'string' == typeof n && (null != r ? (s[n] = r) : (i = n)),
          ...
          function I(t, e, n, r) {
            ...
            return (
              e && 'function' == typeof e.transformPosition
                ? ([s, o] = [t.index, t.index + t.length].map((t) => e.transformPosition(t, r !== E.Z.sources.USER)))
                : ([s, o] = [t.index, t.index + t.length].map((t) =>
                    t < e || (t === e && r === E.Z.sources.USER) ? t : i >= 0 ? t + i : Math.max(e, t + i)
                  )),
              new f.e(s, o - s)
            )
          }
        ...
        6794: function (t, e, n) {
          ...
          class c {
            constructor(t, e) {
              ;(this.emitter = e),
                ...
                this.emitter.listenDOM('selectionchange', document, () => {
                  this.mouseDown || this.composing || setTimeout(this.update.bind(this, o.Z.sources.USER), 1)
                }),
            ...
            getBounds(t) {
              ...
              if (e > 0)
                return (
                  ...
                  null == i ? null : (([r, s] = i.position(s, !0)), o.setEnd(r, s), o.getBoundingClientRect())
                )
              let l,
                a = 'left'
            ...
            normalizeNative(t) {
              if (!u(this.root, t.startContainer) || (!t.collapsed && !u(this.root, t.endContainer))) return null
              const e = {
                start: {
                  ...
                  if (
                    ...
                    t instanceof Element &&
                      ...
                      n instanceof Element &&
                        'BR' === n.tagName &&
                        ((r = Array.from(n.parentNode.childNodes).indexOf(n)), (n = n.parentNode))
            ...
            setRange(t) {
              let e = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : o.Z.sources.API
            ...
            update() {
              const t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o.Z.sources.USER
              ...
              if (
                ...
                const n = [o.Z.events.SELECTION_CHANGE, (0, s.Z)(this.lastRange), (0, s.Z)(e), t]
                this.emitter.emit(o.Z.events.EDITOR_CHANGE, ...n), t !== o.Z.sources.SILENT && this.emitter.emit(...n)
              }
            }
          }
          function u(t, e) {
        ...
        1453: function (t, e, n) {
          ...
          var r = n(8473),
            ...
            m = n(8312),
            b = n(4283)
          const y = (0, l.Z)('quill:clipboard'),
            v = [
              [
                Node.TEXT_NODE,
                function (t, e) {
                  let n = t.data
                  if ('O:P' === t.parentElement?.tagName) return e.insert(n.trim())
                  if (!k(t)) {
                    ...
                    ;(n = n.replace(/\r\n/g, ' ').replace(/\n/g, ' ')),
                      ...
                      ((null == t.previousSibling && null != t.parentElement && q(t.parentElement)) ||
                        (t.previousSibling instanceof Element && q(t.previousSibling))) &&
                        (n = n.replace(/^\s+/, r.bind(r, !1))),
                      ((null == t.nextSibling && null != t.parentElement && q(t.parentElement)) ||
                        (t.nextSibling instanceof Element && q(t.nextSibling))) &&
                        (n = n.replace(/\s+$/, r.bind(r, !1)))
                  }
                  return e.insert(n)
                },
              ...
              [
                ...
                function (t, e, n) {
                  ...
                  if (i.prototype instanceof r.EmbedBlot) {
                    ...
                    (i.prototype instanceof r.BlockBlot && !A(e, '\n') && e.insert('\n'),
                    'function' == typeof i.formats)
                  )
                    return w(e, i.blotName, i.formats(t, n))
                  return e
                },
              ],
              [
                    ...
                    i
                      ...
                      .forEach((e) => {
                        ...
                        ;(null != i && ((l[i.attrName] = i.value(t)), l[i.attrName])) ||
                          ((i = x[e]),
                          null == i || (i.attrName !== e && i.keyName !== e) || (l[i.attrName] = i.value(t) || void 0),
                          (i = N[e]),
                          null == i ||
                            (i.attrName !== e && i.keyName !== e) ||
                            ((i = N[e]), (l[i.attrName] = i.value(t) || void 0)))
                      }),
                    Object.keys(l).length > 0 ? w(e, l) : e
                  )
                },
              ],
              [
                ...
                function (t, e) {
                  const n = {},
                    r = t.style || {}
                  return (
                    'italic' === r.fontStyle && (n.italic = !0),
                    'underline' === r.textDecoration && (n.underline = !0),
                    'line-through' === r.textDecoration && (n.strike = !0),
                    (r.fontWeight?.startsWith('bold') || parseInt(r.fontWeight, 10) >= 700) && (n.bold = !0),
                    Object.keys(n).length > 0 && (e = w(e, n)),
                    parseFloat(r.textIndent || 0) > 0 ? new (s())().insert('\t').concat(e) : e
                  )
                },
              ],
              [
              ...
              [
                'ol, ul',
                function (t, e) {
                  return w(e, 'list', 'OL' === t.tagName ? 'ordered' : 'bullet')
                },
              ],
              [
                'pre',
                function (t, e, n) {
                  ...
                  return w(e, 'code-block', !r || r.formats(t, n))
                },
              ],
              [
                'tr',
                function (t, e) {
                  const n = 'TABLE' === t.parentElement?.tagName ? t.parentElement : t.parentElement?.parentElement
                  if (null != n) return w(e, 'table', Array.from(n.querySelectorAll('tr')).indexOf(t) + 1)
                },
              ],
              ['b', L.bind(L, 'bold')],
              ['i', L.bind(L, 'italic')],
              ['strike', L.bind(L, 'strike')],
              [
                'style',
                function () {
                  return new (s())()
            ...
            x = [u.if, p.IF].reduce((t, e) => ((t[e.keyName] = e), t), {}),
            N = [u.HE, h.w, f.HQ, p.H8, g.H, m.Z].reduce((t, e) => ((t[e.keyName] = e), t), {})
          class E extends a.Z {
            constructor(t, e) {
              super(t, e),
                ...
                (this.matchers = []),
                v.concat(this.options.matchers).forEach((t) => {
                  const [e, n] = t
                  this.addMatcher(e, n)
                })
            }
            ...
            convert(t) {
              const { html: e, text: n } = t,
                r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}
              if (r[d.ZP.blotName])
                return new (s())().insert(n || '', {
                  [d.ZP.blotName]: r[d.ZP.blotName],
                })
              if (!e) return new (s())().insert(n || '')
            ...
            convertHTML(t) {
              const e = new DOMParser().parseFromString(t, 'text/html').body,
                n = new WeakMap(),
                [r, i] = this.prepareMatching(e, n)
              return _(this.quill.scroll, e, r, i, n)
            }
            dangerouslyPasteHTML(t, e) {
              const n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : c.ZP.sources.API
              if ('string' == typeof t) {
          ...
          function w(t, e, n) {
            return 'object' == typeof e
              ? Object.keys(e).reduce((t, n) => w(t, n, e[n]), t)
              : t.reduce((t, r) => {
          ...
          const Z = new WeakMap()
          function k(t) {
            return null != t && (Z.has(t) || ('PRE' === t.tagName ? Z.set(t, !0) : Z.set(t, k(t.parentNode))), Z.get(t))
          }
              ...
              ? Array.from(e.childNodes || []).reduce((s, o) => {
                  ...
                  return (
                    o.nodeType === e.ELEMENT_NODE &&
                      ((l = n.reduce((e, n) => n(o, e, t), l)), (l = (i.get(o) || []).reduce((e, n) => n(o, e, t), l))),
                    s.concat(l)
                  )
                }, new (s())())
              : new (s())()
        ...
        4283: function (t, e, n) {
          ...
          class f extends u.Z {
            static match(t, e) {
              return (
                !['altKey', 'ctrlKey', 'metaKey', 'shiftKey'].some((n) => !!e[n] !== t[n] && null !== e[n]) &&
            ...
            handleEnter(t, e) {
              const n = Object.keys(e.format).reduce(
                  (t, n) => (
                    this.quill.scroll.query(n, l.Scope.BLOCK) && !Array.isArray(e.format[n]) && (t[n] = e.format[n]), t
                  ),
                  {}
                ),
          ...
          const p = {
            bindings: {
              ...
              indent: {
                ...
                handler(t, e) {
                  return !(!e.collapsed || 0 === e.offset) || (this.quill.format('indent', '+1', a.ZP.sources.USER), !1)
                },
              },
              outdent: {
                key: 'Tab',
              ...
              'outdent backspace': {
                ...
                handler(t, e) {
                  null != e.format.indent
                    ...
                    : null != e.format.list && this.quill.format('list', !1, a.ZP.sources.USER)
                },
              },
              ...
              'list empty enter': {
                ...
                handler(t, e) {
                  ...
                  e.format.indent && (n.indent = !1), this.quill.formatLine(t.index, t.length, n, a.ZP.sources.USER)
                },
              },
              'checklist enter': {
                key: 'Enter',
                  ...
                  if (e) {
                    ...
                    if (l < 0) {
                      ...
                      this.quill.updateContents(e, a.ZP.sources.USER),
                        this.quill.setSelection(t.index + 1, t.length, a.ZP.sources.SILENT)
                    } else if (l > 0) {
                      c += n.length()
                      const t = new (o())().retain(c).insert('\n')
                      this.quill.updateContents(t, a.ZP.sources.USER), this.quill.setSelection(c, a.ZP.sources.USER)
                    }
                  }
                },
              },
              ...
              'list autofill': {
                ...
                handler(t, e) {
                  ...
                  this.quill.insertText(t.index, ' ', a.ZP.sources.USER), this.quill.history.cutoff()
                  const l = new (o())()
                    .retain(t.index - i)
                    .delete(n + 1)
                    .retain(r.length() - 2 - i)
            ...
            return {
              ...
              handler(n) {
                ...
                return !(
                  ...
                  ('ArrowLeft' === t
                    ? e
                      ? this.quill.setSelection(n.index - 1, n.length + 1, a.ZP.sources.USER)
            ...
            return {
              ...
              handler(e, n) {
                ...
                if (null != s) {
                  ...
                  null != e &&
                    (t
                      ? this.quill.setSelection(e.offset(this.quill.scroll) + e.length() - 1, 0, a.ZP.sources.USER)
                      : this.quill.setSelection(e.offset(this.quill.scroll), 0, a.ZP.sources.USER))
                }
                return !1
              },
            }
        ...
        9661: function (t) {
          ...
          function i(t, g, m, b, y) {
              ...
              var x = (function (t, e, n) {
                ...
                if (0 === r.length && (null === i || 0 === i.length)) {
                  ...
                  if ((null === u || u === h) && !(h < 0 || h > o)) {
                    ...
                    if ((g = e.slice(h)) === c) {
                      var f = Math.min(l, h)
                      if ((b = a.slice(0, f)) === (x = d.slice(0, f))) return v(b, a.slice(f), d.slice(f), c)
                    }
                  }
                  if (null === u || u === l) {
                    var p = l,
                ...
                if (r.length > 0 && i && 0 === i.length) {
                  ...
                  if (!(o < (f = b.length) + (m = y.length))) {
                    var x = e.slice(0, f),
                      N = e.slice(o - m)
                    if (b === x && y === N) return v(b, t.slice(f, s - m), e.slice(f, o - m), y)
                  }
                }
                return null
              })(t, g, m)
            ...
            var w = t.substring(t.length - N),
              A = (function (t, l) {
                ...
                var f = (function (t, e) {
                  ...
                  function i(t, e, n) {
                    for (
                      var r, i, s, l, c = t.substring(n, n + Math.floor(t.length / 4)), u = -1, h = '';
                      -1 !== (u = e.indexOf(c, u + 1));
                ...
                return (function (t, r) {
                  ...
                  for (var f = i - o, p = f % 2 != 0, g = 0, m = 0, b = 0, y = 0, v = 0; v < l; v++) {
                    for (var x = -v + g; x <= v - m; x += 2) {
                      for (
                        var N = a + x,
                          E = (k = x === -v || (x !== v && u[N - 1] < u[N + 1]) ? u[N + 1] : u[N - 1] + 1) - x;
                      ...
                      else if (p && (q = a + f - x) >= 0 && q < c && -1 !== h[q] && k >= (A = i - h[q]))
                        return s(t, r, k, E)
                    }
                    for (var w = -v + b; w <= v - y; w += 2) {
                      for (
                        var A,
                          q = a + w,
                          Z = (A = w === -v || (w !== v && h[q - 1] < h[q + 1]) ? h[q + 1] : h[q - 1] + 1) - w;
                      ...
                      if (((h[q] = A), A > i)) y += 2
                        ...
                        if ((N = a + f - w) >= 0 && N < c && -1 !== u[N])
                          if (((E = a + (k = u[N]) - N), k >= (A = i - A))) return s(t, r, k, E)
                      }
                    }
                  }
                  return [
            ...
            return (
              ...
              b &&
                (function (t) {
                  for (var i = !1, s = [], o = 0, g = null, m = 0, b = 0, y = 0, v = 0, x = 0; m < t.length; )
                    t[m][0] == r
                      ? ((s[o++] = m), (b = v), (y = x), (v = 0), (x = 0), (g = t[m][1]))
          ...
          function o(t, e) {
            ...
            for (var n = 0, r = Math.min(t.length, e.length), i = r, s = 0; n < i; )
              t.substring(s, i) == e.substring(s, i) ? (s = n = i) : (r = i), (i = Math.floor((r - n) / 2 + n))
                  ...
                  case r:
                    ...
                    if (h.length > 0 || d.length > 0) {
                      h.length > 0 &&
                        d.length > 0 &&
                        (0 !== (s = o(d, h)) &&
                          (f >= 0 ? (t[f][1] += d.substring(0, s)) : (t.splice(0, 0, [r, d.substring(0, s)]), l++),
                          (d = d.substring(s)),
                          (h = h.substring(s))),
                        0 !== (s = a(d, h)) &&
            ...
            for (l = 1; l < t.length - 1; )
              t[l - 1][0] === r &&
                ...
                (t[l][1].substring(t[l][1].length - t[l - 1][1].length) === t[l - 1][1]
                  ? ((t[l][1] = t[l - 1][1] + t[l][1].substring(0, t[l][1].length - t[l - 1][1].length)),
        ...
        9907: function (t, e, n) {
          ...
          function Tt(t, e, n, r, i, f, y) {
            ...
            if (T) {
              if (
                ((O = (function (t) {
                  var e = t.length,
                    n = t.constructor(e)
                  return (
                    e && 'string' == typeof t[0] && tt.call(t, 'index') && ((n.index = t.index), (n.input = t.input)), n
                  )
                })(t)),
                !e)
              )
              ...
              if (C == d || C == s || (R && !f)) {
                ...
                if (
                  ((O = (function (t) {
                    return 'function' != typeof t.constructor || Dt(t) ? {} : Vt((e = ot(t))) ? lt(e) : {}
                    var e
                  })(R ? {} : t)),
                  !e)
                )
          ...
          function Pt(t, e) {
            ...
            return (function (t) {
              return !(!Vt(t) || ((e = t), X && X in e)) && (Kt(t) || F(t) ? nt : O).test(Ut(t))
              var e
            })(n)
              ? n
              : void 0
            ...
            return Ht(t)
              ? (function (t, e) {
                  var n =
                    ...
                    r = n.length,
                    i = !!r
                  for (var o in t) (!e && !tt.call(t, o)) || (i && ('length' == o || Mt(o, r))) || n.push(o)
                  return n
                })(t)
              : (function (t) {
                  if (!Dt(t)) return dt(t)
        ...
        3958: function (t, e, n) {
          ...
          var F,
            ...
            Y = V.toString,
            Q = W.hasOwnProperty,
            X = (F = /[^.]+$/.exec((G && G.keys && G.keys.IE_PROTO) || '')) ? 'Symbol(src)_1.' + F : '',
            J = W.toString,
            tt = RegExp(
              '^' +
                Y.call(Q)
            ...
            return (
              ...
              (null == t || null == e || (!Vt(t) && !Vt(e))
                ...
                : (function (t, e, n, r, o, c) {
                        ...
                        f || Wt(t)
                          ...
                          : (function (t, e, n, r, o, l, a) {
                              switch (n) {
                                ...
                                case E:
                                  var f = r & i
                                  if ((c || (c = z), t.size != e.size && !f)) return !1
                                  var p = a.get(t)
                                  if (p) return p == e
                                  ;(r |= s), a.set(t, e)
                    ...
                    if (!(n & i)) {
                      var _ = x && Q.call(t, '__wrapped__'),
                        L = A && Q.call(e, '__wrapped__')
                      if (_ || L) {
                        var S = _ ? t.value() : t,
                          O = L ? e.value() : e
                      ...
                      (function (t, e, n, r, s, o) {
                        ...
                        if (f && !p) {
                          ...
                          y == v ||
                            !('constructor' in t) ||
                            !('constructor' in e) ||
                            ('function' == typeof y && y instanceof y && 'function' == typeof v && v instanceof v) ||
                            (f = !1)
                        }
          ...
          var Ut = St(
              ...
              ? St
              : function (t) {
                  return Vt(t) && Q.call(t, 'callee') && !it.call(t, 'callee')
                },
            zt = Array.isArray,
            Ft =
              at ||
          ...
          function Gt(t) {
            return null != (e = t) && $t(e.length) && !Ht(e)
              ...
              : (function (t) {
                  if (((n = (e = t) && e.constructor), e !== (('function' == typeof n && n.prototype) || W)))
                    return ct(t)
                  var e,
                    n,
                    r = []
                ...
                if ('insert' === n.peekType()) l.push(n.next())
                  ...
                  if (i.retain) {
                    ...
                    'number' == typeof i.delete &&
                      ('number' == typeof r.retain || ('object' == typeof r.retain && null !== r.retain)) &&
                      l.push(i)
                }
              return l.chop()
            }
                      ...
                      return (
                        t.slice(n, n + i).forEach((t) => {
                          r.delete
                            ...
                            : r.retain &&
                              r.attributes &&
                              e.retain(l.default.length(t), o.default.invert(r.attributes, t.attributes))
                        }),
                        n + i
                      )
                    }
            ...
            transformPosition(t, e = !1) {
              ...
              for (; n.hasNext() && r <= t; ) {
                const i = n.peekLength(),
                  s = n.peekType()
                n.next(),
                  'delete' !== s ? ('insert' === s && (r < t || !e) && (t += i), (r += i)) : (t -= Math.min(i, t - r))
              }
              return t
            }
          }
          ...
          e.default = class {
            ...
            next(t) {
              ...
              if (e) {
                ...
                if (
                  (t >= i - n ? ((t = i - n), (this.index += 1), (this.offset = 0)) : (this.offset += t),
        ...
        6218: function (t, e, n) {
          ...
          ;(o.prototype.clear = function () {
            ...
            (o.prototype.set = function (t, e) {
              ...
              if (n instanceof r.Z) {
                var o = n.__data__
                if (!i.Z || o.length < 199) return o.push([t, e]), (this.size = ++n.size), this
        ...
        5546: function (t, e, n) {
          ...
          var r,
            ...
            g = function (t) {
              return !(!(0, l.Z)(t) || ((e = t), o && o in e)) && ((0, i.Z)(t) ? p : c).test((0, a.Z)(t))
              var e
            },
            m = function (t, e) {
              var n = (function (t, e) {
            ...
            Z = function (t, e, n) {
              ...
              switch (e) {
                ...
                case '[object String]':
                  return new o(t)
                case '[object RegExp]':
                  return ((s = new (i = t).constructor(i.source, N.exec(i))).lastIndex = i.lastIndex), s
                case '[object Symbol]':
              ...
              if (A) {
                if (
                  ((x = (function (t) {
                    ...
                    return (
                      e && 'string' == typeof t[0] && v.call(t, 'index') && ((n.index = t.index), (n.input = t.input)),
                      n
                    )
                  })(e)),
                  !N)
        ...
        8489: function (t, e, n) {
          ...
          var o = s,
                    ...
                    : (function (t, e, n, r, i, s, o) {
                        switch (n) {
                          case '[object DataView]':
                            ...
                            ;(t = t.buffer), (e = e.buffer)
                          case '[object ArrayBuffer]':
                            return !(t.byteLength != e.byteLength || !s(new u.Z(t), new u.Z(e)))
                          case '[object Boolean]':
                          case '[object Date]':
                          case '[object Number]':
                            return (0, h.Z)(+t, +e)
                ...
                (function (t, e, n, r, i, s) {
                  ...
                  if (f && !p) {
                    ...
                    x == N ||
                      !('constructor' in t) ||
                      !('constructor' in e) ||
                      ('function' == typeof x && x instanceof x && 'function' == typeof N && N instanceof N) ||
                      (f = !1)
                  }
            ...
            _ = function t(e, n, r, i, s) {
              return (
                e === n ||
                (null == e || null == n || (!(0, k.Z)(e) && !(0, k.Z)(n)) ? e != e && n != n : Z(e, n, r, i, t, s))
              )
            },
            L = function (t, e) {
              return _(t, e)
        ...
        9534: function (t, e, n) {
          ...
          var r,
            ...
            c = n(8804),
            u = function (t, e, n) {
              ;((void 0 !== n && !(0, c.Z)(t[e], n)) || (void 0 === n && !(e in t))) && (0, a.Z)(t, e, n)
            },
            h = function (t, e, n) {
                      ...
                      ? (0, b.Z)(a)
                        ...
                        : ((l = a),
                          (0, v.Z)(l) && (0, y.Z)(l)
                            ...
                            : (q = []))
                      : (function (t) {
                          if (!(0, v.Z)(t) || '[object Object]' != (0, w.Z)(t)) return !1
                          var e = (0, A.Z)(t)
                          if (null === e) return !0
                          var n = _.call(e, 'constructor') && e.constructor
                          return 'function' == typeof n && n instanceof n && k.call(n) == L
                        })(c) || (0, m.Z)(c)
                      ? ((q = a),
                        (0, m.Z)(a)
                          ? (q = (function (t) {
              ...
              return U(
                (function (t, e, n) {
                  return (
                    ...
                    function () {
                      for (var r = arguments, i = -1, s = I(r.length - e, 0), o = Array(s); ++i < s; ) o[i] = r[e + i]
                      i = -1
                  ...
                  i = o.length > 3 && 'function' == typeof i ? (r--, i) : void 0,
                    s &&
                      (function (t, e, n) {
                        ...
                        var r = typeof e
                        return (
                          !!('number' == r ? (0, y.Z)(n) && (0, F.Z)(e, n.length) : 'string' == r && (e in n)) &&
                          (0, c.Z)(n[e], t)
                        )
                      })(e[0], e[1], s) &&
                      ((i = r < 3 ? void 0 : i), (r = 1)),
        ...
        8473: function (t, e, n) {
          ...
          const o = class {
            ...
            create(t, e, n) {
              ...
              if (null == r) throw new s(`Unable to create ${e} blot`)
              const i = r,
                l = e instanceof Node || e.nodeType === Node.TEXT_NODE ? e : i.create(n),
                a = new i(t, l, n)
              return o.blots.set(a.domNode, a), a
            }
            find(t, e = !1) {
              return o.find(t, e)
            }
            query(t, e = r.ANY) {
              ...
              return (
                'string' == typeof t
                  ...
                  : t instanceof Element &&
                    ((t.getAttribute('class') || '').split(/\s+/).some((t) => ((n = this.classes[t]), !!n)),
                    (n = n || this.tags[t.tagName])),
                null == n ? null : e & r.LEVEL & n.scope && e & r.TYPE & n.scope ? n : null
              )
            }
            register(...t) {
              if (t.length > 1) return t.map((t) => this.register(t))
              const e = t[0]
              if ('string' != typeof e.blotName && 'string' != typeof e.attrName) throw new s('Invalid definition')
              if ('abstract' === e.blotName) throw new s('Cannot register abstract class')
              return (
                (this.types[e.blotName || e.attrName] = e),
                'string' == typeof e.keyName
                  ? (this.attributes[e.keyName] = e)
                  : (null != e.className && (this.classes[e.className] = e),
                    null != e.tagName &&
            ...
            static create(t) {
              ...
              return (
                Array.isArray(this.tagName)
                  ? ('string' == typeof t &&
                      ((t = t.toUpperCase()), parseInt(t, 10).toString() === t && (t = parseInt(t, 10))),
                    (e =
                      'number' == typeof t
          ...
          const u = class extends a {
            ...
            attachUI(t) {
              null != this.uiNode && this.uiNode.remove(),
                (this.uiNode = t),
                u.uiClass && this.uiNode.classList.add(u.uiClass),
            ...
            descendant(t, e = 0) {
              ...
              return (null == t.blotName && t(n)) || (null != t.blotName && n instanceof t)
                ? [n, r]
                : n instanceof u
                ? n.descendant(t, r)
                : [null, -1]
            ...
            descendants(t, e = 0, n = Number.MAX_VALUE) {
              let r = [],
                i = n
              return (
                this.children.forEachAt(e, n, (e, n, s) => {
                  ;((null == t.blotName && t(e)) || (null != t.blotName && e instanceof t)) && r.push(e),
                    e instanceof u && (r = r.concat(e.descendants(t, n, i))),
                    (i -= s)
                }),
                r
              )
            ...
            path(t, e = !1) {
              const [n, r] = this.children.find(t, e),
                i = [[this, t]]
              return n instanceof u ? i.concat(n.path(r, e)) : (null != n && i.push([n, r]), i)
            }
            removeChild(t) {
            ...
            replaceWith(t, e) {
              const n = 'string' == typeof t ? this.scroll.create(t, e) : t
              return n instanceof u && this.moveChildren(n), super.replaceWith(n)
            }
            split(t, e = !1) {
              if (!e) {
                if (0 === t) return this
            ...
            update(t, e) {
              ...
              t.forEach((t) => {
                ...
                n
                  ...
                  .sort((t, e) =>
                    t === e ? 0 : t.compareDocumentPosition(e) & Node.DOCUMENT_POSITION_FOLLOWING ? 1 : -1
                  )
                  .forEach((t) => {
                    let e = null
                    null != t.nextSibling && (e = this.scroll.find(t.nextSibling))
                    const n = c(t, this.scroll)
                    ;(n.next !== e || null == n.next) &&
                      (null != n.parent && n.parent.removeChild(this), this.insertBefore(n, e || void 0))
                  }),
                this.enforceAllowedChildren()
            }
          }
          ...
          ;(d.blotName = 'container'), (d.scope = r.BLOCK_BLOT)
          class f extends a {
            static value(t) {
              return !0
            }
          ...
          class m extends p {
            ...
            remove(t) {
              g(t, this.keyName).forEach((e) => {
                t.classList.remove(e)
              }),
                0 === t.classList.length && t.removeAttribute('class')
            }
            value(t) {
              const e = (g(t, this.keyName)[0] || '').slice(this.keyName.length + 1)
          ...
          class y extends p {
            ...
            add(t, e) {
              return !!this.canAdd(t, e) && ((t.style[b(this.keyName)] = e), !0)
            }
            remove(t) {
              ;(t.style[b(this.keyName)] = ''), t.getAttribute('style') || t.removeAttribute('style')
            }
            value(t) {
              const e = t.style[b(this.keyName)]
              return this.canAdd(t, e) ? e : ''
            }
          }
          class v {
            ...
            build() {
              ...
              if (null == t) return
              const e = p.keys(this.domNode),
                n = m.keys(this.domNode),
                i = y.keys(this.domNode)
              e.concat(n)
                .concat(i)
                .forEach((e) => {
                  const n = t.scroll.query(e, r.ATTRIBUTE)
                  n instanceof p && (this.attributes[n.attrName] = n)
                })
            }
            copy(t) {
          ...
          const x = class extends h {
            constructor(t, e) {
              super(t, e), (this.attributes = new v(this.domNode))
            }
            static formats(t, e) {
              const n = e.query(x.blotName)
              if (null == n || t.tagName !== n.tagName) {
            ...
            format(t, e) {
              if (t !== this.statics.blotName || e) {
                ...
                n instanceof p
                  ...
                  : e && (t !== this.statics.blotName || this.formats()[t] !== e) && this.replaceWith(t, e)
              } else
                this.children.forEach((t) => {
          ...
          const N = x
          ;(N.allowedChildren = [x, f]), (N.blotName = 'inline'), (N.scope = r.INLINE_BLOT), (N.tagName = 'SPAN')
          const E = class extends h {
            constructor(t, e) {
              super(t, e), (this.attributes = new v(this.domNode))
            }
            static formats(t, e) {
              const n = e.query(E.blotName)
              if (null == n || t.tagName !== n.tagName) {
                if ('string' == typeof this.tagName) return !0
                if (Array.isArray(this.tagName)) return t.tagName.toLowerCase()
              }
          ...
          const w = E
          ;(w.blotName = 'block'), (w.scope = r.BLOCK_BLOT), (w.tagName = 'P'), (w.allowedChildren = [N, E, f])
          class A extends f {
            static formats(t, e) {}
            format(t, e) {
          ...
          class Z extends h {
            ...
            optimize(t = [], e = {}) {
              ...
              const i = (t, e = !0) => {
                  null == t ||
                    t === this ||
                    (null != t.domNode.parentNode && (n.has(t.domNode) || n.set(t.domNode, []), e && i(t.parent)))
                },
                s = (t) => {
                  n.has(t.domNode) && (t instanceof h && t.children.forEach(s), n.delete(t.domNode), t.optimize(e))
                }
              let o = t
          ...
          ;(Z.blotName = 'scroll'),
            (Z.defaultChild = w),
            (Z.allowedChildren = [w, d]),
            (Z.scope = r.BLOCK_BLOT),
            (Z.tagName = 'DIV')
          const k = class extends f {
            constructor(t, e) {
            ...
            insertAt(t, e, n) {
              null == n
                ? ((this.text = this.text.slice(0, t) + e + this.text.slice(t)), (this.domNode.data = this.text))
    ...
    return (
      (function () {
            ...
            const n = e.ownerDocument.createElement('span'),
              r = (n) => {
                ...
                'checked' === r
                  ...
                  : 'unchecked' === r && (this.format('list', 'checked'), n.preventDefault())
              }
        ...
        var B = I,
          ...
          $ = n(3583),
          K = n(1453)
        const V = new s.ClassAttributor('code-token', 'hljs', {
          scope: s.Scope.INLINE,
        })
        class W extends N.Z {
          static formats(t, e) {
            for (; null != t && t !== e.domNode; ) {
              if (t.classList && t.classList.contains(M.ZP.className)) return super.formats(t, e)
              t = t.parentNode
            }
          }
          constructor(t, e, n) {
          ...
          highlight(t) {
            ...
            if (e || this.forceNext || this.cachedText !== n) {
              if (n.trim().length > 0 || null == this.cachedText) {
                const e = this.children.reduce((t, e) => t.concat((0, a.qz)(e, !1)), new (U())()),
                  i = t(n, r)
                e.diff(i).reduce((t, e) => {
                  const { retain: n, attributes: r } = e
                  return n
                    ? (r &&
                        Object.keys(r).forEach((e) => {
                          ;[G.blotName, W.blotName].includes(e) && this.formatAt(t, n, e, r[e])
                        }),
                      t + n)
                    : t
                }, 0)
        ...
        ;(Y.allowedChildren = [G]), (G.requiredContainer = Y), (G.allowedChildren = [W, H.Z, $.Z, F.Z])
        class Q extends z.Z {
          static register() {
            p.ZP.register(W, !0), p.ZP.register(G, !0), p.ZP.register(Y, !0)
          }
          constructor(t, e) {
          ...
          highlight() {
            ...
            ;(null == t ? this.quill.scroll.descendants(Y) : [t]).forEach((t) => {
          ...
          highlightBlot(t) {
            ...
            return (
              ...
              (n.innerHTML = this.options.hljs.highlight(e, t).value),
              (0, K.fw)(
                this.quill.scroll,
                n,
                [
        ...
        class rt extends z.Z {
          ...
          deleteTable() {
            ...
            if (null == t) return
            const e = t.offset()
            t.remove(), this.quill.update(p.ZP.sources.USER), this.quill.setSelection(e, p.ZP.sources.SILENT)
          }
          getTable() {
            const t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : this.quill.getSelection()
          ...
          insertColumn(t) {
            ...
            let o = r.rowOffset()
            0 === t && (o += 1), this.quill.setSelection(e.index + o, e.length, p.ZP.sources.SILENT)
          }
          insertColumnLeft() {
            this.insertColumn(0)
          }
          ...
          insertRow(t) {
            ...
            n.insertRow(s + t),
              ...
              t > 0
                ...
                : this.quill.setSelection(e.index + r.children.length, e.length, p.ZP.sources.SILENT)
          }
          insertRowAbove() {
            this.insertRow(0)
          }
          ...
          attach(t) {
            ...
            t.addEventListener(n, (n) => {
              ...
              if ('SELECT' === t.tagName) {
                ...
                (r = !t.classList.contains('ql-active') && (t.value || !t.hasAttribute('value'))), n.preventDefault()
              this.quill.focus()
        ...
        function lt(t, e, n) {
          ...
          r.setAttribute('type', 'button'),
            ...
            null != n ? ((r.value = n), r.setAttribute('aria-label', `${e}: ${n}`)) : r.setAttribute('aria-label', e),
            t.appendChild(r)
        }
        ;(ot.DEFAULTS = {}),
          (ot.DEFAULTS = {
            ...
            handlers: {
                ...
                if (null != t)
                  if (0 === t.length) {
                    ...
                    Object.keys(t).forEach((t) => {
                      null != this.quill.scroll.query(t, s.Scope.INLINE) && this.quill.format(t, !1, p.ZP.sources.USER)
                    })
              ...
              indent(t) {
                ...
                if ('+1' === t || '-1' === t) {
                  let e = '+1' === t ? 1 : -1
                  'rtl' === n.direction && (e *= -1), this.quill.format('indent', r + e, p.ZP.sources.USER)
                }
              },
              link(t) {
                !0 === t && (t = prompt('Enter link URL:')), this.quill.format('link', t, p.ZP.sources.USER)
              },
              list(t) {
                const e = this.quill.getSelection(),
                  n = this.quill.getFormat(e)
        ...
        var at =
          ...
          ct = {
            ...
            indent: {
              '+1': '<svg viewbox="0 0 18 18"> <line class="ql-stroke" x1="3" x2="15" y1="14" y2="14"></line> <line class="ql-stroke" x1="3" x2="15" y1="4" y2="4"></line> <line class="ql-stroke" x1="9" x2="15" y1="9" y2="9"></line> <polyline class="ql-fill ql-stroke" points="3 7 3 11 5 9 3 7"></polyline> </svg>',
              '-1': '<svg viewbox="0 0 18 18"> <line class="ql-stroke" x1="3" x2="15" y1="14" y2="14"></line> <line class="ql-stroke" x1="3" x2="15" y1="4" y2="4"></line> <line class="ql-stroke" x1="9" x2="15" y1="9" y2="9"></line> <polyline class="ql-stroke" points="5 7 5 11 3 9 5 7"></polyline> </svg>',
            },
        ...
        var dt = class {
          ...
          gt = class {
            ...
            position(t) {
              ...
              let s = 0
              if (
                (i.right > r.right && ((s = r.right - i.right), (this.root.style.left = `${e + s}px`)),
                i.left < r.left && ((s = r.left - i.left), (this.root.style.left = `${e + s}px`)),
                i.bottom > r.bottom)
              ) {
          ...
          buildPickers(t, e) {
            ;(this.pickers = Array.from(t).map((t) => {
              ...
              if (t.classList.contains('ql-background') || t.classList.contains('ql-color')) {
                ...
                return (
                  null == t.querySelector('option') && Zt(t, xt, 'background' === n ? '#ffffff' : '#000000'),
                  new ft(t, e[n])
                )
              }
              return (
        ...
        class qt extends gt {
          ...
          edit() {
            const t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 'link',
          ...
          save() {
            ...
            switch (this.root.getAttribute('data-mode')) {
              case 'link': {
                ...
                this.linkRange
                  ? (this.quill.formatText(this.linkRange, 'link', t, bt.Z.sources.USER), delete this.linkRange)
              ...
              case 'formula': {
                ...
                if (null != e) {
                  ...
                  this.quill.insertEmbed(n, this.root.getAttribute('data-mode'), t, bt.Z.sources.USER),
        ...
        class St extends At {
          constructor(t, e) {
            null != e.modules.toolbar && null == e.modules.toolbar.container && (e.modules.toolbar.container = _t),
              super(t, e),
            ...
            super.listen(),
              ...
              this.root.querySelector('a.ql-remove').addEventListener('click', (t) => {
                if (null != this.linkRange) {
                  ...
                  this.restoreFocus(), this.quill.formatText(t, 'link', !1, bt.Z.sources.USER), delete this.linkRange
                }
        ...
        class jt extends At {
          constructor(t, e) {
            null != e.modules.toolbar && null == e.modules.toolbar.container && (e.modules.toolbar.container = Ot),
              super(t, e),
